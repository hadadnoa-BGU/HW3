...
public class LevelManager {
    ...
    public Object[] loadNextLevel(Player player, MessageCallbacks msgCallback, DeathCallback dthCallback,
                                  ChangedPositionCallback cPosCallback) {
                ...
                for (int x = 0; x < width; x++) {
                    ...
                    switch (c) {
                        ...
                        case '@':
                            ...
                            break;
                        case 's':
                            Enemy skeleton = new Monster("Skeleton", 50, 10, 5, 20, 3, pos);
                            skeleton.initialize(dthCallback, msgCallback, cPosCallback);
                            board.setTile(x, y, skeleton);
                            enemies.add(skeleton);
                            break;
                        case 'k':
                            Enemy king = new Boss("The King", 100, 20, 10, 50, 5, 3, pos);
                            king.initialize(dthCallback, msgCallback, cPosCallback);
